pipeline{
    ...
    stages {
        ...
        stage ('Publishing to Nexus'){
            steps {
                echo ' publishing...'
                nexusArtifactUploader artifacts: [[artifactId: 'devopslesson', classifier: '',
                 file: 'target/devopslesson-0.1.8.war', type: 'war']],
                  credentialsId: '8987bc36-3605-4f47-b09f-4b5a8175906c',
